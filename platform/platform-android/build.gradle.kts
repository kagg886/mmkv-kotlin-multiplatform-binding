...
val LIB_PLATFORM_ANDROID_VERSION = System.getenv("LIB_PLATFORM_ANDROID_VERSION") ?: project.findProperty("LIB_PLATFORM_ANDROID_VERSION") as? String ?: "unsetted."
check(LIB_PLATFORM_ANDROID_VERSION.startsWith("v")) {
    "LIB_PLATFORM_ANDROID_VERSION not supported, current is $LIB_PLATFORM_ANDROID_VERSION"
}

group = "top.kagg886.mkmb"
version = LIB_PLATFORM_ANDROID_VERSION.substring(1)

println("LIB_PLATFORM_ANDROID_VERSION: $version")
